# MAGEMAX React JS Admin Dashboard v1.0
Version: 1.0
...
1. Install latest Node.js from here (https://nodejs.org)
2. Install latest Yarn Package Manager from here (https://yarnpkg.com)

3. In your terminal type "npm install"
4. Run app in Development Mode Type "npm start" OR "yarn start"
5. For build production files Type "npm run build" OR "yarn build"    
